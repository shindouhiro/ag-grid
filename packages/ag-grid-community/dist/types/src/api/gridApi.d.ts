...
export interface GridApi<TData = any> extends _CoreGridApi<TData>, _StateGridApi, _RowSelectionGridApi<TData>, _RowGridApi<TData>, _ScrollGridApi<TData>, _KeyboardNavigationGridApi, _EventGridApi<TData>, _ValueCacheApi, _ValueApi<TData>, _CommunityMenuGridApi, _SortGridApi, _OverlayGridApi, _PinnedRowGridApi, _RenderGridApi<TData>, _HighlightChangesGridApi<TData>, _DragGridApi, _ColumnAutosizeApi, _ColumnResizeApi, _ColumnMoveApi, _ColumnHoverApi, _ColumnGridApi<TData>, _ColumnGroupGridApi, _DragGridApi, _EditGridApi<TData>, _UndoRedoGridApi, _FilterGridApi, _ColumnFilterGridApi, _QuickFilterGridApi, _FindApi<TData>, _PaginationGridApi, _CsrmSsrmSharedGridApi, _SsrmInfiniteSharedGridApi, _ClientSideRowModelGridApi<TData>, _SideBarGridApi<TData>, _StatusBarGridApi<TData>, _InfiniteRowModelGridApi, _CsvExportGridApi, _RowGroupingGridApi, _AggregationGridApi<TData>, _PivotGridApi<TData>, _CellSelectionGridApi, _ServerSideRowModelGridApi<TData>, _ContextMenuGridApi, _ColumnChooserGridApi, _MasterDetailGridApi, _ExcelExportGridApi, _ClipboardGridApi, _GridChartsGridApi, _AdvancedFilterGridApi {
